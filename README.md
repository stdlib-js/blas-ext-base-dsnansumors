...
```javascript
dsnansumors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dsnansumors@v0.3.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dsnansumors@v0.3.1-umd/browser.js"></script>
```
